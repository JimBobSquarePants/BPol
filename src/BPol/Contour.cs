...
namespace BPol
{
    ...
    public sealed class Contour
    {
        ...
        private readonly List<int> holes = new List<int>();
        ...
        {
            return (p == this.NVertices)
                ? new Segment(this.points[0], this.points[this.points.Count - 1])
        ...
        /// </summary>
        /// <returns>The <see cref="Vector2"/>.</returns>
        public Vector2 Back() => this.points[this.points.Count - 1];
