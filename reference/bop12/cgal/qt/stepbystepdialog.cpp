...
StepByStepDialog::StepByStepDialog (const Polygon& subject, const Polygon& clipping, 
									bop::BooleanOpType op, QWidget* parent) : QDialog (parent)
{
	...
	boi = new bop::BooleanOpImp (subject, clipping, *result, op, doSomething, somethingDone, true);
	boi->start ();
